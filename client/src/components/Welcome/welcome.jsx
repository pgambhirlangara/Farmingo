...
const Welcome = () => {
  const useStyles = makeStyles((theme) => ({
    banner: {
      ...
      width: "100% !important",
      backgroundImage:
        "url(./assets/landing-page.jpg), linear-gradient(90deg, rgba(91, 175, 97, 0.5) 1.28%, rgba(248, 177, 51, 0.5) 105.7%)",
    ...
    <section>
      <div className={classes.banner}>
        <div className={classes.bannerContent}>
          ...
          <h1 className={classes.bannerTitle}>
            Buy locally from farmers and access a B2B digital marketplace that
            offers fair food trade
          </h1>
      ...
      <div className={classes.featureSection}>
        <div className={classes.featureSectionItem}>
          <img
            className={classes.featureSectionIcon}
      ...
      <div className={classes.joinUsSection}>
        <div className={classes.leftSection}>
          ...
          <p className={classes.leftSectionDescription}>
            {" "}
            As a farmer, you sell directly to customers rather than through
            distributors. We market your brand, handle orders, and more, all
            while you benefit from an online presence that will help you build a
            loyal customer base. You are paid
          </p>
          <Divider className={classes.divider} />
        ...
        <div className={classes.rightSection}>
          <div className={classes.rightSectionImage}>
            ...
            <p className={classes.rightSectionDescription}>
              FarminGo is excited to announce the opening of our first location
              inside of Canada in South Vancouver, as well as the trade of local
              and fresh produce from your local farmers.
            </p>
          </div>
        </div>
      </div>
